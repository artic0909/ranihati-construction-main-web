...
@section('content')
                            ...
                            <table class="table responsive table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align: left;">
                                        <td>1</td>
                                        <td>
                                            <img src="{{ asset('./img/logo.png') }}" alt="About Image"
                                                style="width: 100px; height: 100px; object-fit: cover;">
                                        </td>
                                        <td>+91-1234567890</td>
                                        <td>RCPL@gmail.com</td>
                                        <td><button class="btn btn-success" data-bs-toggle="modal"
                                                data-bs-target="#viewAboutDescriptionOneModal"><i
                                                    class='bx bx-file'></i></button></td>
                                        <td><button class="btn btn-success" data-bs-toggle="modal"
                                                data-bs-target="#viewAboutDescriptionTwoModal"><i
                                                    class='bx bx-file'></i></button></td>
                                        <td>
                                            <button class="btn btn-info me-2" data-bs-toggle="modal"
                                                data-bs-target="#updateAboutModal"><i class='bx bx-pencil'></i></button>
                                            <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteAboutModal"><i class='bx bx-trash'></i></button>
                                        </td>
                                    </tr>
            ...
            <form class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descriptionOne" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="descriptionTwo" class="form-label">Description Two</label>
                        <textarea class="form-control" id="descriptionTwo" rows="3"></textarea>
                    </div>
    ...
    <!-- Update About Modal -->
    <div class="modal fade" id="updateAboutModal" tabindex="-1" aria-labelledby="updateAboutModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content">
                <div class="modal-header">
    ...
    <!-- Delete Modal -->
    <div class="modal fade" id="deleteAboutModal" tabindex="-1" aria-labelledby="deleteAboutModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="viewAboutDescriptionOneModal" tabindex="-1" aria-labelledby="viewAboutDescriptionOneModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="viewAboutDescriptionTwoModal" tabindex="-1" aria-labelledby="viewAboutDescriptionTwoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content">
                <div class="modal-header">
