            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-info">
                        ...
                        <div class="contact-item" style="height: 100%;">
                            <iframe
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        <div id="success"></div>
                        <form name="sentMessage" id="contactForm" action="{{ route('careers.store') }}" method="POST"
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="qualification"
                                    placeholder="Final Qualification (e.g., B.Tech, MBA, Diploma)" name="qualification"
                                    required="required" maxlength="255" minlength="2"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="control-group">
                                        <input type="number" class="form-control" id="tenthMarks"
                                            placeholder="10th Marks(%)" name="tenth_percentage" required="required" min="0"
                                            max="100" step="0.01"
                                ...
                                <div class="col-md-6">
                                    <div class="control-group">
                                        <input type="number" class="form-control" id="hsMarks" placeholder="HS Marks (%)"
                                            name="hs_percentage" required="required" min="0" max="100" step="0.01"
                                ...
                                <div class="col-md-6">
                                    <div class="control-group">
                                        <input type="tel" class="form-control" id="phone"
                                            placeholder="Phone Number (10 digits)" name="phone" required="required"
                                ...
                                <div class="col-md-6">
                                    <div class="control-group">
                                        <input type="text" class="form-control" id="address" placeholder="Address"
                                            name="address" required="required" minlength="10" maxlength="500"
