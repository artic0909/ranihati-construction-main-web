                ...
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <select class="form-control" id="jobPost" required="required"
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="qualification"
                                placeholder="Final Qualification" required="required"
                        ...
                        <div class="control-group">
                            ...
                            <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                <label style="display: flex; align-items: center; gap: 5px; cursor: pointer;">
                                    <input type="radio" name="hsDivision" value="art" required="required"
                                        data-validation-required-message="Please select HS division" />
                                    <span>Art</span>
                                </label>
                                <label style="display: flex; align-items: center; gap: 5px; cursor: pointer;">
                                    <input type="radio" name="hsDivision" value="science" />
                                    <span>Science</span>
                                </label>
                                <label style="display: flex; align-items: center; gap: 5px; cursor: pointer;">
                                    <input type="radio" name="hsDivision" value="commerce" />
                                    <span>Commerce</span>
                                </label>
                            </div>
                            <p class="help-block text-danger"></p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="control-group">
                                    <input type="text" class="form-control" id="tenthMarks"
                                        placeholder="10th Marks(%)" required="required"
                            ...
                            <div class="col-md-6">
                                <div class="control-group">
                                    <input type="text" class="form-control" id="hsMarks"
                                        placeholder="HS Marks (%)" required="required"
